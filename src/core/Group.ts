	...
	export class Group implements Kiwi.IChild {
		...
		*/
		...
		@param [getGroups=true] {boolean} Whether to include Groups
			in the results
		@param [destinationArray] {array} Array in which to store the results
		@return {array}
		@since 1.1.0
		**/
		...
		**/
		...
		or if they are at the same index (that is, they are the same object).
		...
		**/
		...
		@param newChild {object} Child to insert at the old child's position
		@return {boolean} Whether children were replaced successfully
		@public
		**/
		public replaceChild(
		...
		/**
		Loop through each member in the group and run a method for each one.
		...
		**/
		...
		Useful for distinguishing between many of the same type of GameObject.
