    ...
    export class TileMapLayer {
        ...
        */
        ...
        public parseTileOffsets(): number {
            ...
            //console.log("margin " + this.tileMargin);
            //console.log("height " + this._texture.height);
            //console.log("width " + this._texture.width);
        ...
        */
        ...
        public render( camera: Kiwi.Camera): bool {
            ...
            //1 - is tilemap bounds within camera bounds
            // - false - return false
            
            //2 - how many tiles fit across cam and down cam
            //3 - where is the camera in relation to the tilemap
            ...
            */
            ...
            for (var row = this._startY; row < this._startY + this._maxY; row++) {
                ...
                for (var tile = this._startX; tile < t This._startX + this._maxX; tile++) {
                    if (this._tileOffsets[this._columnData[tile]]) {
