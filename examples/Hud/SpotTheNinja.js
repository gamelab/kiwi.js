...
**/
var SpotTheNinja = new Kiwi.State('SpotTheNinja');
    
SpotTheNinja.preload = function () {
    this.addImage('ninja', 'assets/static/ninja.png');
}

SpotTheNinja.create = function () {
...
SpotTheNinja.timerCheck = function () {
...
SpotTheNinja.changeNinjaCoords = function () {
...
SpotTheNinja.scoreIncrease = function () {
    if (this.game.huds.supported)
        this.score.counter.increase();
    this.changeNinjaCoords();
}
...
var game = new Kiwi.Game('game', 'KiwiExample', SpotTheNinja, options);