...
EasingMethods.create = function () {

    //Text
    var text = new Kiwi.GameObjects.Textfield(this, 'Click anywhere to start the tweening!', this.game.stage.width / 2, 10, '#000', 12);
    ...
    for (var i = 0; i < easing.length; i++) {
        var bullet = new Kiwi.GameObjects.Sprite(this, this.textures.bullet, 50, 40 * i + 20);
...
var game = new Kiwi.Game('game', 'KiwiExample', EasingMethods, options);