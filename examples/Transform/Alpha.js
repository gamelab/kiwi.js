...
Alpha.create = function () {
    ...
    **/
    ...
    this.snakeA = new Kiwi.GameObjects.Sprite(this, this.textures.snake, 250, 30);
    this.addChild(this.snakeA);
    this.snakeA.alpha = 0.5;

    this.snakeB = new Kiwi.GameObjects.StaticImage(this, this.textures.snake, 400, 30);
...
var game = new Kiwi.Game('game', 'KiwiExample', Alpha, options);