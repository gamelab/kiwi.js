...
class Marker_Playing extends Kiwi.State {
    ...
    create() {
        ...
        this.random = this.game.audio.add('random', 1, true);
        ...
        this.boy = new Kiwi.GameObjects.Sprite(this,this.textures.boy, 100, 100, true);
        this.horn = new Kiwi.GameObjects.Sprite(this,this.textures.horn, 300, 100, true);
        this.prin = new Kiwi.GameObjects.Sprite(this,this.textures.prin, 500, 100, true);
