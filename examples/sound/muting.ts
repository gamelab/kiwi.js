...
class muting extends Kiwi.State {
    ...
    create() {
        ...
        this.tomato = new Kiwi.GameObjects.Sprite(this,this.textures.tomato, 100, 100, true);
        this.pepper = new Kiwi.GameObjects.Sprite(this,this.textures.pepper, 400, 100, true);
