...
class MachineGunDeath extends Kiwi.State {

    constructor() {
        super('MachineGunDeath');
    }
    ...
    bullets: Custom[];
    tank: Kiwi.GameObjects.Sprite;
    troops: Custom[];

    oww: Kiwi.Sound.Audio;
    dead: Kiwi.Sound.Audio;
    bang: Kiwi.Sound.Audio;
    ...
    create() {
        ...
        this.tank = new Custom(this, this.textures.tank, 100, 400);
    ...
    spawn() {
        var t = new Custom(this, this.textures.troop, this.game.stage.width + 50, 400);
...
class Custom extends Kiwi.GameObjects.Sprite {
    ...
    public health: number = 2; //only for troops
...
var game = new Kiwi.Game('game', 'KiwiExample', MachineGunDeath, options);