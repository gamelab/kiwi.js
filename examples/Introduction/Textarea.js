...
Textarea.create = function () {
    ...
    **/
    this.text1 = new Kiwi.GameObjects.Textfield(this, 'Hello to the world', 10, 10, '#000');
    this.addChild(this.text1);

    this.text2 = new Kiwi.GameObjects.Textfield(this, 'Here is some more text.', this.game.stage.width, 20, 'red', 16);
...
var game = new Kiwi.Game('game', 'KiwiExample', Textarea, options);