...
/**
* This script is a demonstration of how you can modify the tiledata of a tilemap layer after it has been created to fill in an area.
*
**/

var FillingAnArea = new Kiwi.State('FillingAnArea');

FillingAnArea.preload = function () {
    //Load in the TileMap
...
FillingAnArea.press = function(x, y) {
    this.isDown = true;
...
FillingAnArea.replace = function(x, y) {
...
var game = new Kiwi.Game('game', 'KiwiExample', FillingAnArea,  gameOptions);